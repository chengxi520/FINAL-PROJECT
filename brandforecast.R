...
par(mfrow=c(2,1))
library(ggplot2)
barplot(pub.table.2[,3],xaxt="n", main="log(Observed/Expected) for Car Sales 05/18")
text( x=1.182759*1:29, y=0,names(sort(pub.table[,3])),  srt=45)
barplot(pub.table.2[,4],xaxt="n", main="Deviance Given Expected Standard Deviation Forecast Car Sales 05/18")
